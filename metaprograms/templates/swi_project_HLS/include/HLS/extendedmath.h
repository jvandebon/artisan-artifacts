...
#if defined(_MSC_VER)
// Add 'deprecated' attribute to POPCOUNT32 and POPCOUNT64
__declspec(deprecated("please use 'popcount', 'popcountc', 'popcounts' or 'popcountl' instead")) unsigned POPCOUNT32(unsigned __x);
__declspec(deprecated("please use 'popcountll' instead")) unsigned POPCOUNT64(unsigned long long __x);
inline unsigned POPCOUNT32(unsigned __x)           { return (unsigned)__popcnt(__x); }
inline unsigned POPCOUNT64(unsigned long long __x) { return (unsigned)__popcnt64(__x); }
// Substitute following popcount functions with MSVC builtins
...
#else
// Add 'deprecated' attribute to POPCOUNT32 and POPCOUNT64
unsigned POPCOUNT32(unsigned __x)      __attribute__((deprecated("please use 'popcount', 'popcountc' or 'popcounts' instead")));
unsigned POPCOUNT64(unsigned long __x) __attribute__((deprecated("please use 'popcountl' or 'popcountll' instead")));
inline unsigned POPCOUNT32(unsigned __x)      { return (unsigned)__builtin_popcount(__x); }
inline unsigned POPCOUNT64(unsigned long __x) { return (unsigned)__builtin_popcountl(__x); }
// Substitute following popcount functions with GCC builtins
