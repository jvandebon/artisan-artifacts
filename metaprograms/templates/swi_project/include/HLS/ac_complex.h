...
inline double abs(ac_complex<double> a) { return ::sqrt(a.r()*a.r() + a.i()*a.i()); }
inline double arg(ac_complex<double> a) { return atan(a.i()/a.r()); }
inline ac_complex<double> sqrt(ac_complex<double> a) { return ac_complex<double>(::sqrt((a.r()+abs(a))/2),a.i()/(2*::sqrt((a.r()+abs(a))/2))); }
inline ac_complex<double> exp(ac_complex<double> a) { return ac_complex<double>(::exp(a.r())*cos(a.i()),::exp(a.r())*sin(a.i())); }
inline ac_complex<double> log(ac_complex<double> a) { return ac_complex<double>(::log(abs(a)),arg(a)); }
inline ac_complex<double> inv(ac_complex<double> a) { return ac_complex<double>(a.r()/a.mag_sqr(),-a.i()/a.mag_sqr()); }

inline float abs(ac_complex<float> a) { return sqrtf(a.r()*a.r() + a.i()*a.i()); }
inline float arg(ac_complex<float> a) { return atanf(a.i()/a.r()); }
inline ac_complex<float> sqrt(ac_complex<float> a) { return ac_complex<float>(sqrtf((a.r()+abs(a))/2),a.i()/(2*sqrtf((a.r()+abs(a))/2))); }
inline ac_complex<float> exp(ac_complex<float> a) { return ac_complex<float>(expf(a.r())*cosf(a.i()),expf(a.r())*sinf(a.i())); }
inline ac_complex<float> log(ac_complex<float> a) { return ac_complex<float>(logf(abs(a)),arg(a)); }
inline ac_complex<float> inv(ac_complex<float> a) { return ac_complex<float>(a.r()/a.mag_sqr(),-a.i()/a.mag_sqr()); }
