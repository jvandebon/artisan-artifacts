...
#define __fpclassify(__x) __x_fpclassifyfd(__x)
...
#define __fpclassifyf(__x) __x_fpclassifyf(__x)

inline long __x_signbitfd(double __x) { unsigned long xbits = *((unsigned long*)&__x); return xbits >> 63 << 7; }
#define __signbit(__x) __x_signbitfd(__x)

inline int __x_signbitf(float __x) { unsigned xbits = *((unsigned*)&__x); return xbits >> 31 << 3; }
#define __signbitf(__x) __x_signbitf(__x)
