...
from sdt_create_swi_fpga_project import create_swi_project

def gen_swi_fpga_project(cli):
    if not os.path.exists("./swi_project"):
        ...
        create_swi_project(ast, "/workspace/metaprograms/templates/", "swi_ws/default", hotspot_func, header)
